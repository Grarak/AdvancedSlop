...
pub fn get_common_c_flags() -> Vec<String> {
    ...
    if !is_target_vita() {
        ...
        // ADVANCEDSLOP_SYSROOT is the armhf cross sysroot; native hosts use their own.
        if is_target_arm32() {
...
pub fn create_c_build() -> cc::Build {
    ...
    build.compiler("clang-21").archiver("llvm-ar-21");
...
pub fn create_bindgen_builder() -> bindgen::Builder {
    ...
    // Both supported targets are 32-bit arm and share the thumbv7 layout.
