// Slim mirror of advancedslop's `crate::jit` module — ONLY the disassembler island, with the leaf
// modules pointed at the real advancedslop source files. Because `disassembler` points at the real
...
// Private-`use` re-export, exactly as advancedslop's jit/mod.rs does it: descendant modules
